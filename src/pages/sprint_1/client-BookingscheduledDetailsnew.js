...
function ClientBookingscheduledDetailsnew () {
                    ...
                    <div class="row mt-4 mt-sm-4 ">
                        <div class="col-md-8 mt-2">
                            <div class="service-head">
                                ...
                                <h2><span><a href="#">Bookings</a></span> <img src="images/service-arrowright.svg" class="mr-2" alt="" />Scheduled</h2>
                            </div>
                        </div>
                    ...
                    <div class="row mt-3 align-items-center">
                        <div class="col-md-10 col-12 mb-2 mb-sm-0">
                            <div class="row">
                                ...
                                <button type="button" class="btn btn-login">CHAT WITH THE SERVICE PROVIDER</button>
                                </div>
                            </div>
...
export default ClientBookingscheduledDetailsnew;
