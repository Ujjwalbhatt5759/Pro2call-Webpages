                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-9 col-7">
                            <ul class="tophead-right">
                                <li><a href="#"><button type="button" class="btn btn-login">SIGNUP</button></a></li>
                            </ul>
                        </div>
            ...
            <div class="container min-heighvh position-relative">
               <div class="row pt-4">
                <div class="col-md-6 mt-2 pt-5 mt-sm-5 position-inherit">
                        ...
                        <div class="col-md-9 mt-3">
                            ...
                            <div class="row mt-3 mt-sm-4">
                                <div class="col-md-7 col-7">
                                    <button type="button" class="btn btn-login ">CONTINUE WITH EMAIL</button>
                                </div>
                    ...
                    <div class="row mt-3 mt-sm-4">
                        <div class="col-md-6">
                            <button type="button" class="btn btn-light continue-btn mb-3"><img src="images/Google-loginlogo.svg" height="22px" class="mr-2" alt="" /> Continue with Google</button>
                        </div>
                        <div class="col-md-6 pl-3 pl-sm-0">
                            <button type="button" class="btn btn-light continue-btn"><img src="images/Facebook-loginlogo.svg" height="22px" class="mr-2" alt="" />Continue with Facebook</button>
                        </div>
                    </div>
