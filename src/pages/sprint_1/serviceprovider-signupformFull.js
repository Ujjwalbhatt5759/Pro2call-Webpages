...
function ServiceproviderSignupformFull () {
                    ...
                    <div class="row mt-4 align-items-end">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <label for="#" class="profile-label">Full name</label>
                                <input type="email" class="form-control login-input profile-inpt" placeholder="Vinod Sharma" />
                            </div>

                            <div class="form-group">
                                <label for="#" class="profile-label">Describe about you</label>
            ...
            <section class="service-providerfullbgBottom">
                <div class="container">
                    <div class="row mt-4">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="#" class="profile-label">Basic details</label>
                            ...
                            <label for="#" class="profile-label">Documents</label>
                            ...
                            <div class="row mt-4">
                                <div class="col-md-12">
                                    <button type="button" class="btn btn-login mr-3 ">VERIFY MY ACCOUNT</button>
...
export default ServiceproviderSignupformFull;