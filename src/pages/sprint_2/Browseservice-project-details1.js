...
function Browseserviceprojectdetails1() {
        ...
        <>
                    ...
                    <div class="row mt-4 mt-sm-4 ">
                        <div class="col-md-8 mt-2">
                            <div class="service-head">
                                ...
                                <h2><span><a href="#">Home</a></span> <img src="images/service-arrowright.svg" class="mr-2" alt="" /> <span><a href="#">Plumber</a></span> <img src="images/service-arrowright.svg" class="mr-2" alt="" /> Drainage</h2>
                            </div>
                        </div>
                                ...
                                <div class="fixed-costbox">
                                    <div class="row align-items-end">
                                        ...
                                        <div class="col-md-7 col-6">
                                            <button type="button" class="btn btn-login" onClick={handleShow} >SELECT SERVICES</button>
                                        </div>
                                    </div>
                    ...
                    <div class="row mt-4">
                        <div class="col-md-12 mb-3">
                            <div class="service-head ">
                                ...
                                <h1>related <span>services</span></h1>
                                <h2><span><a href="#">view more </a></span> <img src="images/service-arrowright.svg" alt="" /></h2>
                            </div>
                        </div>

                        <div class="col-md-4">
                            <div class="services-box found-center">
                                <div class="servicebox-img">
                                    <img src="images/service-img.png" class="service-img" alt="" />
                                </div>
                        ...
                        <div class="col-md-4">
                            <div class="services-box found-center">
                                <div class="servicebox-img">
                                    <img src="images/service-img2.png" class="service-img" alt="" />
                                </div>
                                <div class="company-box gay-textfond">
                                    <h6 class="d-flex align-items-center mb-2"><img src="images/gray-brwn.svg" class="mr-2" alt="" /> INDIVIDUAL</h6>
                                    <h5>Drainage pipe blockage removal</h5>
                        ...
                        <div class="col-md-4">
                            <div class="services-box found-center">
                                <div class="servicebox-img">
                                    <img src="images/service-img3.png" class="service-img" alt="" />
                                </div>
                                <div class="company-box">
                                    <h6 class="d-flex align-items-center mb-2"><img src="images/verify.png" class="mr-2" alt="" /> COMPANY</h6>
                                    <h5>Drainage pipe blockage removal</h5>
            ...
            <Modal show={show} onHide={handleClose} className="filter-popup modal-dialog-slideout">
                <Modal.Header closeButton>
                    <Modal.Title>
                        <div class="service-head">
                            ...
                            <h1>select <span>services</span></h1>
                        </div>
                    </Modal.Title>
                </Modal.Header>
                <Modal.Body>
                    <div class="row mt-2">
                        <div class="col-md-7 col-7 pr-0">
                            <div class="wash-installationSelect">
                        ...
                        <div class="col-md-5  col-5">
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    <span class="input-group-text lfet-btnpopup">
                                        <button type="button" class="btn popup-btnint">-</button>
                                    </span>
                                </div>
                                <input type="text" class="form-control popup-input" placeholder="2" />
                                <div class="input-group-append">
                                    <span class="input-group-text righ-btnpopup">
                                        <button type="button" class="btn  popup-btnint popup-btnright">+</button>
                                    </span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="border-bottom selcet-servicesmargintop"></div>
                ...
                <Modal.Footer>
                    ...
                    <button type="button" class="btn btn-login">UPDATE & PROCEED</button>
...
export default Browseserviceprojectdetails1;
