                ...
                <div class="container">
                    <div class="row mt-2 mt-sm-3 align-items-center">
                        <div class="col-md-10 pr-0">
                            ...
                            <button class="uploadBtn mr-3 mb-2 text-uppercase">PAST BOOKINGS</button>
                        </div>
                    ...
                    <div class="row mt-3">
                        <div class="col-md-12">
                           <h6 class="services-labeltext">April, 2022</h6>
                        </div>
                    </div>
...
export default ClinetBookingpast;