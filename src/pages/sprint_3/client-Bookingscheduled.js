...
function ClientBookingscheduled() {
        ...
        <>
            ...
            <section class="pb-4 pb-sm-5">
                <div class="container">
                            ...
                            <div class="col-md-7">
                                <div class="service-publicSec">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 text-left text-sm-right col-12 ">
                            ...
                            <div class="col-md-7">
                                <div class="service-publicSec service-publicpink">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 text-left text-sm-right col-5">
                                            <button class="btn btn-login new-loginbtn text-uppercase">View Details</button>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="row mt-3">
                        <div class="col-md-12">
                            <h6 class="services-labeltext">July, 2022</h6>
                        </div>
                    </div>
                            ...
                            <div class="col-md-7">
                                <div class="service-publicSec">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 text-sm-right text-left col-5 ">
                                            <button class="btn btn-login new-loginbtn text-uppercase">View Details</button>
                                        </div>
                                    </div>
                                </div>
...
export default ClientBookingscheduled;