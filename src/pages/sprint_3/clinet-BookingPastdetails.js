...
function ClientBookingPastdetails () {
                ...
                <div class="row mt-4 mt-sm-4 ">
                        <div class="col-md-8 mt-2">
                            <div class="service-head">
                                ...
                                <h2><span><a href="#">Bookings</a></span> <img src="images/service-arrowright.svg" class="mr-2" alt="" />Past bookings</h2>
                            </div>
                        </div>
                                ...
                                <div class="fixed-costbox">
                                    ...
                                    <div class="row align-items-end">
                                        ...
                                        <div class="col-md-8 col-8">
                                            <h1 >$730.00</h1>
                                            <button type="button" class="btn btn-login mt-2" onClick={handleShow} >REVIEW THIS SERVICE</button>
                                        </div>
                ...
                <Modal.Header closeButton>
                    <Modal.Title>
                        <div class="service-head">
                            ...
                            <h1>feedback for  <span>service provider</span></h1>
                        </div>
                    </Modal.Title>
                </Modal.Header>
                <Modal.Body>
...
export default ClientBookingPastdetails;
