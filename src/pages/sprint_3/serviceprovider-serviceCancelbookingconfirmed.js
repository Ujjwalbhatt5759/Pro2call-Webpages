...
function ServiceproviderServicesCancelbookingconfirmed () {
                ...
                <div class="container min-heighvh position-relative">
                    <div class="row pt-4">
                        <div class="col-md-12 mt-2 pt-5 mt-sm-5 position-inherit">
                            <h1>booking <span>cancelled</span></h1>
                            <h2>thank you</h2>
                                ...
                                <div class="col-md-5">
                                    ...
                                    <div class="row align-items-center mt-3 booking-confirmed">
                                        <div class="col-md-9 col-8">
                                            <h4>You will get a refund within 7 - 14 days</h4>
                            ...
                            <div class="row mt-4 mb-4">
                                <div class="col-md-12">
                                    <button type="button" class="btn btn-login mr-3" onClick={handleShow}>BOOKED SERVICES</button>
                                    <button type="button" class="btn btn-light details-btn">BACK TO LIST</button>
                                </div>
                            </div>
...
export default ServiceproviderServicesCancelbookingconfirmed;