...
function ServiceproviderServicesPaymentpending () {
                            ...
                            <div class="col-md-7">
                                <div class="service-publicSec">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 text-left text-sm-right col-12 pl-3 pl-sm-0">
                                            <button class="btn btn-login new-loginbtn text-uppercase">SEND REQUEST</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
export default ServiceproviderServicesPaymentpending;