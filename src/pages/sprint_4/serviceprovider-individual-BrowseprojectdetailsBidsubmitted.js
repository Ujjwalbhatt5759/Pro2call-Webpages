...
function ServiceproviderindividualBrowseprojectdeatialsBidsubmitted() {
                        ...
                        <div class="col-md-12 mt-2 pt-5 mt-sm-5 position-inherit">
                            ...
                            <div class="booking-confirmed">
                                <div class="row mt-3 mt-sm-4">
                                    <div class="col-md-4">
                                        ...
                                        <span className="submitted-bidblue">You can bid for 4 more projects as per you plan.</span>
                            ...
                            <div class="row">
                                <div class="col-md-5">
                                    ...
                                    <div class="row align-items-center mt-3 booking-confirmed">
                                        <div class="col-md-12">
                                            <h4>Project</h4>
                                            <h5>Full bathroom hardware installation for corporate office</h5>
                                            <h1 class="mt-3">$375.00</h1>
                                            <span class="bid-submittedtext">Your bid on Jun 22nd, 2022 at 4:30pm</span>
                                        </div>
                            ...
                            <div class="row mt-4 mb-4">
                                <div class="col-md-12">
                                    <button type="button" class="btn btn-login mr-3" onClick={handleShow}>MY PROJECTS</button>
...
export default ServiceproviderindividualBrowseprojectdeatialsBidsubmitted;