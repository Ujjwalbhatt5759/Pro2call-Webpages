                ...
                <div class="container">
                    ...
                    <div class="row mt-2 mt-sm-3 align-items-center">
                        <div class="col-md-9">
                            ...
                            <button class="uploadBtn mr-3 mb-2 text-uppercase">PAST PROJECTS</button>
                                    ...
                                    <div class="col-md-6 my-2 my-sm-0">
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-md-11  col-10">
                                                <div class="service-item pl-0 pl-sm-2">
...
export default ClientprojectPast;