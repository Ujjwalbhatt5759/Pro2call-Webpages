...
function ClientProjectInprogressdetails() {
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="row mt-1 align-items-center">
                                                            ...
                                                            <div class="col-md-4 col-3">
                                                                <div class="">
                                                                    <input class="filled-in" type="checkbox" value="" id="Check21" />
                                                                    <label class="checkFrom-label" for="Check21"></label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
...
export default ClientProjectInprogressdetails;
