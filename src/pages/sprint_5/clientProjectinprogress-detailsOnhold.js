...
function ClientProjectInprogressdetailsOnhold () {
                ...
                <div class="container">
                    ...
                    <div class="row mt-3">
                        <div class="col-md-8 mb-3 mb-sm-0">
                            ...
                            <div class="client-chatboxdetails client-onholdchatbox ml-0 ml-sm-3 mt-2">
                                <div class="rightchatboxbg">
                                    <div class="row align-items-center">
                                        <div class="col-md-2 d-none d-sm-inline-block">
                                            <img src="images/client-onholdimg.png" class="chatboxrightimg" alt="" />
                                        </div>
                                        <div class="col-md-6 mb-2 mb-sm-0">
                                            <h1>Contact support now</h1>
                                            <p><a href="#">The project has been marked on hold.</a></p>
                                        </div>
                                        <div class="col-md-4 text-right">
                                            <button type="button" class="btn btn-login">CLICK TO CHAT NOW</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="fixed-costbox">
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-md-7 text-right col-7">
                                            <h6 class="text-uppercase">ON HOLD</h6>
                                        </div>
                                    </div>
                                    <div class="row mt-3">
                                        <div class="col-md-6 col-7">
...
export default ClientProjectInprogressdetailsOnhold;
