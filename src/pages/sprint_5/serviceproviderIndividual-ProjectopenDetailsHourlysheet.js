...
function ServiceproviderindividualProjectopenDetailsHourlysheet () {
                                    ...
                                    <Accordion.Body>
                                        <div class="project-milestonesinner">
                                            ...
                                            <div class="delivery-milestoneboxaccord ">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <label class="milestonepupup-label mt-2">Timesheet</label>
                                                    </div>
                                                    <div class="col-md-7">
                                                        <div class="form-group position-relative">
                                                            <input type="email" class="form-control milestonepupup-input biding-rightpadding" placeholder="Work title here" />
                                                    ...
                                                    <div class="col-md-4 pl-3 pl-sm-0">
                                                        <div class="form-group">
                                                            <input type="email" class="form-control milestonepupup-input" placeholder="Time spent (in hrs)" />
                                                        </div>
                                                    </div>
...
export default ServiceproviderindividualProjectopenDetailsHourlysheet;
