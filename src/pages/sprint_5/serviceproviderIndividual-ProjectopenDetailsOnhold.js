...
function ServiceproviderindividualProjectopenDetailsOnhold () {
                                ...
                                <div class="fixed-costbox">
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-md-7 text-right col-7">
                                            <h6 class="text-uppercase">PROJECT ON HOLD</h6>
                                        </div>
                                    </div>
                                    <div class="row mt-3">
...
export default  ServiceproviderindividualProjectopenDetailsOnhold;
