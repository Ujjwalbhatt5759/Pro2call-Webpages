...
function ServiceproviderindividualProjectMybidsDetailsbidwithdrawn () {
    ...
    return (
        <>
            ...
            <section class="client-section service-sectionbookingcancel  position-relative">
                ...
                <div class="container min-heighvh position-relative">
                    <div class="row pt-4 ">
                        <div class="col-md-12 mt-2 pt-5 mt-sm-5 position-inherit">
                            <h1>bid  <span>withdrawn</span></h1>
                            <h2>successfully</h2>

                            <div class="booking-confirmed">
                                <div class="row mt-3 mt-sm-4">
                                    <div class="col-md-4">
                                        <p>Your bid for the project has been withdrawn with the project ID# PR0000238</p>
                                        <h6>If you’re facing any difficulty while bidding a project, please feel free to contact our dedicated support team.</h6>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-5">
                                    <div class="border-bottom my-3 my-sm-4"></div>
                                   
                                    <button type="button" class="btn btn-login mr-3" onClick={handleShow}>CONTACT SUPPORT</button>
                                    <button type="button" class="btn btn-light details-btn">BROWSE PROJECTS</button>
...
export default ServiceproviderindividualProjectMybidsDetailsbidwithdrawn;