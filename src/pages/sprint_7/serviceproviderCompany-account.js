...
function ServiceproviderCompanyAccount () {
        ...
        <>
                    ...
                    <div class="tophead border-bottom">
                        <div class="row align-items-center">
                            <div class="col-md-5 col-5 moblogo">
                                ...
                                <button type="button" class="btn btn-login ml-4 d-none d-sm-inline-block" onClick={handleShow} >WANT TO HIRE SOMEONE ?</button>
                            </div>
            ...
            <section class="client-section   position-relative ">
                    ...
                    <div class="container-fluid h-100">
                        <div class="row h-100">
                            <div class="col-md-3 order-sm-2 pr-0 h-100">
                                <img src="images/account-right.png" class="loginbg" alt="" />
                            </div>
                ...
                <div class="container min-heighvh position-relative">
                    ...
                    <div class="row mt-2 align-items-center">
                        <div class="col-md-6 mb-3 mb-sm-0">
                            <div class="client-accountbox">
                                <p>Hey Vinod, you are registered as a Service Provider with Protocall. However if you wish you can <span><a href="#">post a project</a></span> and register as a client too.</p>
                            </div>
                        </div>
                    ...
                    <div class="row mt-3 pb-4 pb-sm-0">
                        <div class="col-md-4 mb-3 mb-sm-0">
                            <div class="account-Profile-Settings">
                                <div class="row align-items-center">
                                    <div class="col-md-8 col-8">
...
export default ServiceproviderCompanyAccount;