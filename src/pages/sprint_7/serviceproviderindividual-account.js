...
function ServiceproviderindividualAccount () {
            ...
            <section class="client-section   position-relative account-sectionbg">
                ...
                <div class="container min-heighvh position-relative">
                    ...
                    <div class="row mt-4 pb-4">
                        <div class="col-md-12">
                        <button type="button" class="btn btn-outline-primary post-btn " onClick={handleShow} >LOGOUT FROM PROTOCALL</button>
                        </div>
                    </div>
...
export default ServiceproviderindividualAccount;