...
function ServiceproviderindividualSelectorbrowse () {
                    ...
                    <div class="row pt-4">
                        <div class="col-md-12 mt-2 pt-5 mt-sm-5 position-inherit">
                            ...
                            <div class="row mt-3 mt-sm-2 mb-4">
                                <div class="col-md-12">
                                    <button type="button" class="btn btn-login ">CONTINUE TO BROWSE</button>
                                </div>
                            </div>
...
export default ServiceproviderindividualSelectorbrowse;