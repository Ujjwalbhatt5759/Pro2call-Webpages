...
function ServiceproviderindividaulReportsServices () {
            ...
            <section class="service-providerFullbg pb-4 pb-sm-5">
                <div class="container">
                    ...
                    <div class="row mt-3">
                         ...
                         <button class="uploadBtn mr-3 text-uppercase">SERVICES</button>
                            <button type="button" class="btn btn-outline-dark mayment-btn text-uppercase">PROJECTS</button>
                        ...
                        <div class="col-md-3 mb-3 mb-sm-0">
                            <div class="client-reportservicesbox">
                                <div class="row">
                                    <div class="col-md-12">
                                        <h1>HIRED</h1>
                                        <p>Total service in this month (till now)</p>
                            ...
                            <div class="client-reportservicesbox client-reportservicesboxcancelled">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <h2> <img src="images/more-circle.svg" alt="" />82</h2>
                        ...
                        <div class="col-md-3  mt-3">
                            <div class="client-reportservicesbox client-reportservicesboxcompleted">
                                <div class="row">
                                    <div class="col-md-12">
                                        <h1>EXPENSE</h1>
                                        <p>Completed services this month (till now)</p>
                            ...
                            <div class="client-reportservicesbox client-reportservicesboxcancelled">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <p>Services (in progress) (till now)</p>
                        ...
                        <div class="col-md-3 mt-3">
                            <div class="client-reportservicesbox">
                                <div class="row">
                                    <div class="col-md-12">
                                        <h1>SUCCESS RATIO</h1>
                                        <p>Total services vs completed</p>
...
export default ServiceproviderindividaulReportsServices;