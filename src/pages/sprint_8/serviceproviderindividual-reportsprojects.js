...
function ServiceproviderindividualReportsProjects () {
                            ...
                            <div class="client-reportservicesbox client-reportservicesboxcancelled">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <h2> <img src="images/more-circle.svg" alt="" />N/a</h2>
                        ...
                        <div class="col-md-3 mt-3">
                            <div class="client-reportservicesbox">
                                <div class="row">
                                    <div class="col-md-12">
                                        <h1>SUCCESS RATIO</h1>
                                        <p>Total projects vs completed</p>
...
export default ServiceproviderindividualReportsProjects;