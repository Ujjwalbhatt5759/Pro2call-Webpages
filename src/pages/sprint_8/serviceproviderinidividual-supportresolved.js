...
function ServiceproviderindividualSupportresolved () {
                ...
                <div class="container">
                    <div class="row mt-2 mt-sm-3 align-items-center">
                        <div class="col-md-9 pr-0">
                             <button type="button" class="btn btn-outline-dark mayment-btn mb-2 mr-3 text-uppercase">OPEN TICKETS  <span class="notification-numb open-tickets ">3</span></button>
                             <button class="uploadBtn mb-2 mr-3 text-uppercase">RESOLVED TICKETS</button>
                ...
                <div class="container">
                    <div class="row mt-2">
                        ...
                        <h6 class="services-labeltext">June, 2022</h6>
                            ...
                            <h6 class="services-labeltext mt-3">May, 2022</h6>
...
export default  ServiceproviderindividualSupportresolved;