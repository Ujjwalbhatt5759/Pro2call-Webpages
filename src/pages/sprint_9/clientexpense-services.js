...
function ClientexpensesServices () {
                ...
                <div class="container">
                    ...
                    <Navbar.Collapse id="basic-navbar-nav">
                        <Nav className="mr-auto">
                            ...
                            <Nav.Link href="#" className="active"><img src="images/dollar-squareblue.svg" alt="" />EXPENSE</Nav.Link>
                ...
                <div class="container">
                    <div class="row  mt-2">
                        <div class="col-md-7 mb-2 mb-sm-0">
                            <button type="button" class="btn btn-outline-dark mayment-btn text-uppercase   mr-3">  PROJECTS</button>
                            <button class="uploadBtn  text-uppercase">SERVICES</button>
...
export default ClientexpensesServices;