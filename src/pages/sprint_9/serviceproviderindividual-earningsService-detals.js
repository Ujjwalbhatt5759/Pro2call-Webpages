...
function ServiceproviderindividualEarningsServicesDetails () {
                    ...
                    <div class="row mt-3 align-items-center">
                        <div class="col-md-9">
                            <div class="row">
                                ...
                                <div class="col-md-3  my-2 my-sm-0 col-6">
                                    <div class="serviceListeddetails-head">
                        ...
                        <div class="col-md-3 text-left text-sm-right">
                            <button type="button" class="btn btn-warning exlpore-btn new-explorebtn text-uppercase" >CONTACT SUPPORT</button>    
                        </div>
...
export default  ServiceproviderindividualEarningsServicesDetails;
